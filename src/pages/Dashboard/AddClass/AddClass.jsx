    ...
    const onSubmit = data => {
      ...
      .then(imgResponse =>{
        if(imgResponse.success){
          ...
          const newClass = {class_name, instructor_name, instructor_email, price: parseFloat(price), available_seats: parseFloat(available_seats), image: imgURL, status: "pending"}
